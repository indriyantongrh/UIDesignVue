      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 class="text-center pt-6 font-weight-light display-2">Temukan kami</h1>
            ...
            <v-row class="text-center">
              <v-col class="column">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                           <a target="blank_" href="https://play.google.com/store">
                       <v-img max-width="300px" src="~@/assets/img/playstore.png"></v-img>
                           </a>
                    </div>
              ...
              <v-col class="column">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                       <a target="blank_" href="https://www.apple.com/app-store/">
                          <v-img max-width="300px"  src="~@/assets/img/appstore.png" />
                       </a>
              </div>
